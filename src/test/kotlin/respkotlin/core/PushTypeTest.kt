...
import respkotlin.core.PushType

@TestInstance(TestInstance.Lifecycle.PER_CLASS)
class PushTypeTest {

    @Test
    fun `test push deserializer`() {
        // given
        val data = ">1\r\n$3\r\nfoo\r\n".toByteArray()
        // when
        ...
        val data1 = ">2\r\n$3\r\nfoo\r\n$2\r\nba\r\n".toByteArray()
        // when
        val result1 = PushType.deserialize(data1)
        // then
        ...
        val data2 = ">2\r\n$1\r\nf\r\n$3\r\nbar\r\n".toByteArray()
        // when
        val result2 = PushType.deserialize(data2)
        // then
        ...
        val data3 = ">2\r\n$3\r\nfoo\r\n$3\r\nbar\r\n".toByteArray()
        // when
        val result3 = PushType.deserialize(data3)
        // then
        ...
        val data4 = ">3\r\n:42\r\n:-42\r\n:+43\r\n".toByteArray()
        // when
        val result4 = PushType.deserialize(data4)
        // then
        assert(result4 == listOf(42L, -42L, 43L))
    }

    @Test
    fun `test push deserializer with mixed data types`() {
        // given
        val data = ">3\r\n$3\r\nfoo\r\n:1000\r\n$3\r\nbar\r\n".toByteArray()
        // when
        val result = PushType.deserialize(data)
    ...
    @Test
    fun `test nested push deserialize`() {
        // given
        val data = ">2\r\n*2\r\n$3\r\nfoo\r\n$3\r\nbar\r\n$3\r\nbaz\r\n".toByteArray()
        // when
        val result = PushType.deserialize(data)
    ...
    @Test
    fun `test nested push deserialize with mixed data types`() {
        // given
        val data = ">2\r\n*2\r\n$3\r\nfoo\r\n:1000\r\n$3\r\nbar\r\n".toByteArray()
        // when
        val result = PushType.deserialize(data)
    ...
    fun `test push serialize`() {
        ...
        val list1 = listOf("fo\no", 1000L)
        // when
        val matched3 = PushType.serialize(list1)
        // then
